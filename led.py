...
if __name__ == '__main__':
    try:
        ...
        while True:
            ...
            colorWipe(pixels, (255, 0, 0), rate=10)  # Red wipe
            colorWipe(pixels, (0, 255, 0), rate=10)  # Blue wipe
            colorWipe(pixels, (0, 0, 255), rate=10)  # Green wipe
            ...
            rainbow(pixels, wait_ms=5)
            rainbowCycle(pixels)
            theaterChaseRainbow(pixels)

    except KeyboardInterrupt:
        colorWipe(pixels, (0,0,0), 1, rate=5)
